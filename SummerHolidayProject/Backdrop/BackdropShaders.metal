...
} ColorInOutForBackdrop;


// Captured image fragment function for `Backdrop`
fragment float4 capturedImageFragmentShaderForBackdrop(ImageColorInOut in [[stage_in]],
...
// Anchor geometry vertex function for `Backdrop`
vertex ColorInOutForBackdrop anchorGeometryVertexTransformForBackdrop(Vertex in [[stage_in]],
                                                constant SharedUniforms &sharedUniforms [[ buffer(kBufferIndexSharedUniforms) ]],
                                                constant InstanceUniforms *instanceUniforms [[ buffer(kBufferIndexInstanceUniforms) ]],
                                                ushort vid [[vertex_id]],
                                                ushort iid [[instance_id]]) {
    ColorInOutForBackdrop out;
...
// Anchor geometry fragment function for `Backdrop`
fragment float4 anchorGeometryFragmentLightingForBackdrop(ColorInOutForBackdrop in [[stage_in]],
