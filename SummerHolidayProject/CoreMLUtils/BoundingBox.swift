...
class BoundingBox {
    ...
    func show(frame: CGRect, label: String, color: UIColor) {
        ...
        let attributes = [NSAttributedStringKey.font: textLayer.font as Any]
        
        let textRect = label.boundingRect(with: CGSize(width: 400, height: 100), options: NSStringDrawingOptions.truncatesLastVisibleLine, attributes: attributes, context: nil)
